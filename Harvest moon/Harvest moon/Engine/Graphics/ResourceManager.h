...
public:
	static ResourceManager* getInstance() {
		if (_resourceManagerInstance == NULL) _resourceManagerInstance = new ResourceManager();
	...
	void printLoadedGraphics();	// Pinta el path dels grafics carregats
...
protected:
	ResourceManager();	// Constructor of an empty ResourceManager.


private:
	static ResourceManager* _resourceManagerInstance;	// Singleton instance
